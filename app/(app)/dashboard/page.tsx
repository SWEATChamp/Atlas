      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ margin: '4px 0 0', fontSize: '0.875rem', color: 'var(--text-secondary)' }}>
            {totalMissions > 0
              ? `${completedToday}/${totalMissions} missions done today · Overall readiness ${Number(overall_readiness).toFixed(0)}%`
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          ...
          <div style={{
            ...
            <span style={{ fontWeight: 700, fontSize: '0.9rem', color: streakActive ? '#FF7B35' : 'var(--text-muted)' }}>
          ...
          <div style={{
            ...
            <span style={{ fontWeight: 700, fontSize: '0.9rem', color: 'var(--success)' }}>
              {Number(overall_readiness).toFixed(0)}% ready
            </span>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div className="card" style={{ padding: 'var(--space-5)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
            ...
            {totalMissions > 0 && (
              <div style={{ marginLeft: 'auto', fontFamily: 'var(--font-mono)', fontSize: '0.8rem', fontWeight: 700, color: 'var(--text-muted)' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          {/* XP & Level card */}
          <div className="card" style={{ padding: 'var(--space-5)' }}>
            <div style={{ fontSize: '0.7rem', fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 14 }}>
              XP & Level
            </div>
            <XpLevelBar
          ...
          <div className="card" style={{ padding: 'var(--space-5)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              ...
              <div>
                <div style={{ fontFamily: 'var(--font-display)', fontSize: '1.75rem', fontWeight: 800, lineHeight: 1, color: streakActive ? '#FF7B35' : 'var(--text-muted)' }}>
                  {streak.current}
                </div>
            ...
            {!streakActive && streak.current > 0 && (
              <div style={{ marginTop: 10, fontSize: '0.7rem', color: 'var(--warning)', background: 'rgba(251,191,36,0.08)', border: '1px solid rgba(251,191,36,0.15)', borderRadius: 6, padding: '6px 10px' }}>
