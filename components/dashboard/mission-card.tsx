...
import { BookOpen, RefreshCw, FileSearch, AlertTriangle, Star, Check, Zap, RotateCcw } from 'lucide-react'
...
export default function MissionCard({ mission, onComplete, onUndo }: MissionCardProps) {
  ...
  const handleUndo = (e: React.MouseEvent) => {
    ...
    startTransition(async () => {
      ...
      if (error) {
        console.error('Mission undo failed:', error)
        return
      }
      setDone(false)
      setCompletedAt(null)
