...
export function PaperCard({
  ...
  return (
    <>
      <div
        className="card paper-card-responsive"
      ...
      >
        {/* Left: paper code + subject + stage as accessible primary link */}
        <Link
          href={`/past-papers/${paper.id}`}
          aria-label={`View attempt for ${paper.paper_code}`}
          className="paper-card-primary-link"
        >
          <div
            style={{
        ...
        {/* Bottom / secondary row container */}
        <div className="paper-card-bottom-row">
          {/* Centre: score + meta */}
