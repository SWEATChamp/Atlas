...
- v1.1.1 (Singapore Infrastructure Migration) was prepared on 2026-09-01 as an operational patch release moving database and authentication services to Singapore (`ap-southeast-1`). The infrastructure cutover is completed and production-verified; application metadata and returning-user notification updates are locally prepared. All 27 existing migration records were restored, verified, and audited during project migration; accounts, subjects, progress, missions, past papers, and XP were preserved intact.
