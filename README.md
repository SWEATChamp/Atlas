...
- v1.2.0 (Accessible UI Foundation & Subject Controls Guide) was merged to `main` via PR #12 at merge commit `abed20ba325e99113813a8860be7f4a22c1fc39c` (feature branch head `bff4c5b0cc24d435187e7a1974a19a7c9fd30687`), deployed to Vercel production (deployment `9RCwZ6xAY7ohAqxNn2msJzcCXcUi` on `https://atlas-alpha-vert.vercel.app` via Singapore `sin1`), and verified through authenticated production smoke testing on 2026-09-02. It establishes an accessible dependency-free `Dialog` primitive, restrained dark design system, two-step Subject controls guide (`atlas_subject_controls_guide_v1`), responsive 320px–1280px layouts with zero horizontal overflow, compliant touch targets (≥44×44px) across 320px–768px touch-oriented viewports, returning-user `v1.2.0` release notification with upgrade detection from v1.1.1 and dismissal persistence, visible `Atlas v1.2.0` footer, and canonical status/confidence mappings. Formal annotated tag and GitHub Release closeout remain pending.
